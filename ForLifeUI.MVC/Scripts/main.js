(function ($) {
    ...
    $('#Admin-button').on('click', function (e) {
        e.preventDefault();
        if (!$("#Patient-button").next('#login-form').hasClass('open')) {
            target = $("#Patient-button").next('#login-form');
            target.slideUp('slow');
            $("#Patient-button").next('#login-form').removeClass('open');
        }
        if (!$("#Donor-button").next('#login-form').hasClass('open')) {
            target = $("#Donor-button").next('#login-form');
            target.slideUp('slow');
            $("#Donor-button").next('#login-form').removeClass('open');
        }
        var self = $(this),
    ...
    $('#Donor-button').on('click', function (e) {
        e.preventDefault();
        if (!$("#Patient-button").next('#login-form').hasClass('open')) {
            target = $("#Patient-button").next('#login-form');
            target.slideUp('slow');
        ...
        if (!$("#Admin-button").next('#login-form').hasClass('open')) {
            target = $("#Admin-button").next('#login-form');
            target.slideUp('slow');
            $("#Admin-button").next('#login-form').removeClass('open');
        }
        var self = $(this),
            target = self.next('#login-form');
        if (self.hasClass('open')) {
    ...
    $('#Patient-button').on('click', function (e) {
        e.preventDefault();       
        if (!$("#Admin-button").next('#login-form').hasClass('open')) {
            target = $("#Admin-button").next('#login-form');
            target.slideUp('slow');
